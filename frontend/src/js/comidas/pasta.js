...
export default function PastaApp() {
  ...
  const pizzas = [
    { id: 1, name: "Pasta 4 Quesos", rating: 3, price: 12.99, image: "../img/pasta/pasta_4quesos.jpg" },
    { id: 2, name: "Pasta Boloñesa", rating: 4, price: 14.99, image: "../img/pasta/pasta_bolonesa.jpg" },
    { id: 3, name: "Pasta al Pesto", rating: 3, price: 13.99, image: "../img/pasta/pasta_pesto.jpg" },
    { id: 4, name: "Pasta Alfredo", rating: 5, price: 16.99, image: "../img/pasta/pasta_alfredo.jpg" },
  ];
